...
namespace VetClinic_Rest.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Phone_number")] Clients clients)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Phone_number")] Clients clients)
        {
            if (id != clients.ID)
            {
                return NotFound();
